...
Mod for the Artemis Cosmos Spaceship Bridge Simulator game that enlivens the gui audio with cheery-sounding beeps from Artemis version 2.
...
Fully compatible with all missions

Mod Compatibility:

Mod (& version) | Is it ok to install both mods? | In what order should they be installed? | Would the Cheery Beeps Mod work? | Other comments
--- | --- | --- | --- | ---
